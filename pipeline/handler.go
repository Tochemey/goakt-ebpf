...
// Shutdown shuts down handlers that implement HandlerShutdown (e.g. to flush
// pending spans to the exporter). Call this before process exit for clean shutdown.
